...
class OpenWeather_LocationsPage extends Adw.PreferencesPage {
    _init(parent, settings, extension) {
        super._init({
            title: _("Locations"),
    ...
    _addLocation() {
        ...
        _dialog.connect('response', (w, response) => {
            if (response == 0) {
                ...
                let resultsWindow = new SearchResultsWindow(this._window, this._settings, _location, this._extension);
                resultsWindow.show();
            }
            _dialog.close();
            return 0;
...
class OpenWeather_SearchResultsWindow extends Adw.PreferencesWindow {
    _init(parent, settings, location, extension) {
        super._init({
